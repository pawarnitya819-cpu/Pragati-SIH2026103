export default function GithubButton() {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 inline-flex items-center gap-2 font-semibold pl-3 pr-4 py-2.5 rounded-full shadow-card ring-1 ring-white/10 transition-colors bg-[#0B1D3A] text-white hover:bg-[#152a52]"
    >
