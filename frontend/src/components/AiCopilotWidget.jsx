        ...
        <div className="absolute bottom-[75px] right-0 w-[330px] max-w-[90vw] bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden">
          ...
          <div className="p-4 bg-slate-50 max-h-[380px] overflow-y-auto">
            ...
            {/* GitHub link box */}
              ...
              className="mt-3 w-full flex items-center gap-2 bg-blue-50 hover:bg-blue-100/70 border border-blue-500/30 text-slate-900 text-xs font-bold px-3 py-2.5 rounded-lg transition-colors no-underline"
            >
