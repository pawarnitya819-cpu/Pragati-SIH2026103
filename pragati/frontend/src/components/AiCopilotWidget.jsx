...
export default function AiCopilotWidget() {
  ...
  useEffect(() => {
    ...
    const handleMove = (e) => {
       ...
       * after CURSOR_IDLE_MS, smoothly return eyes to centre.
       */
    ...
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[1000]">
        ...
        <div className="absolute bottom-[75px] right-0 w-[330px] max-w-[90vw] bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden">
          ...
          <div className="p-4 bg-slate-50 max-h-[380px] overflow-y-auto">
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-3 text-xs text-slate-600 leading-relaxed mb-3 space-y-2">
              ...
              <p>
                👋 Hi! I'm the PRAGATI AI Copilot.
              </p>

              <p>
                <strong>PRAGATI</strong> (Pro-Active Governance and Timely
                Implementation) tracks big government infrastructure
                projects — like highways, railways, and power plants —
                across India, showing spending, real progress, and delay risks.
              </p>

              <p>
                This chatbot is a preview build for evaluation —
                full AI features are coming in the next version.
              </p>
            ...
            {!showRoadmap ? (
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-3 text-xs text-slate-600 leading-relaxed space-y-2">
                ...
                <ul className="space-y-1.5">
                  ...
                  <li>
                    🗺️ <strong>Geospatial map</strong> — tap on your
                    state or city to explore project data visually
                  </li>

                  <li>
                    🤖 <strong>A user-friendly AI chatbot</strong> —
                    to help guide users through the platform
                  </li>

                  <li>
                    📊 <strong>Full AI-powered project analysis</strong>
                  </li>

                  <li>
                    🌫️ <strong>Pollution & environmental impact analysis</strong>
                  </li>

                  <li>
                    📅 <strong>Upcoming projects overview</strong> —
                    track timelines and details of future developments
                  </li>
      ...
      <button
        ...
        className="
          ...
          justify-center
          bg-[#071A33]
          shadow-[0_8px_20px_rgba(7,26,51,0.30)]
          hover:scale-105
          active:scale-95
      ...
      >
        ...
        <div
          className="
            ...
            bg-[#071A33]
            shadow-[
              inset_4px_4px_10px_rgba(255,255,255,0.12),
              inset_-5px_-7px_12px_rgba(0,0,0,0.45)
            ]
          "
        >
          ...
          {isBlinking ? (
            ...
            <>
              ...
              <circle
                ...
                style={{
                  transition:
                    "cx 0.18s cubic-bezier(.2,.8,.2,1), cy 0.18s cubic-bezier(.2,.8,.2,1)",
                }}
              />
              ...
              <circle
                cx={64 + rightPupil.x * 4}
                cy={42 + rightPupil.y * 4}
                r="5"
                fill="#071A33"
                style={{
                  transition:
              ...
              <circle
                cx={34.5 + leftPupil.x * 4}
                cy={40.5 + leftPupil.y * 4}
                r="1.5"
                fill="white"
                opacity="0.9"
              />
              ...
              <circle
                cx={62.5 + rightPupil.x * 4}
                cy={40.5 + rightPupil.y * 4}
                r="1.5"
                fill="white"
                opacity="0.9"
              />
